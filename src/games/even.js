...
import greetingAndAnswer from '../cli.js';
...
const displayResultOfQuestions = () => {
  ...
  return console.log(`Congratulations, ${greetingAndAnswer}!`);
};
export default displayResultOfQuestions;
greetingAndAnswer();
